...
import { DollarSign, TrendingUp, TrendingDown, Receipt, Tag, Plus, ArrowUpRight, ArrowDownRight } from "lucide-react"
...
const recentTransactions = [
  ...
  { id: 3, description: "Coffee Shop", amount: -12.5, category: "Food", date: "2024-01-14" },
  { id: 4, description: "Salary", amount: 3000.0, category: "Income", date: "2024-01-13" },
  { id: 5, description: "Utilities", amount: -120.0, category: "Bills", date: "2024-01-12" },
]
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="vintage-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold">${mockStats.totalExpenses.toFixed(2)}</div>
            <p className="text-xs text-muted-foreground">
              <span
                className={`inline-flex items-center ${mockStats.monthlyChange < 0 ? "text-vintage-income-green" : "text-vintage-expense-red"}`}
              >
      ...
      <Card className="vintage-card">
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" asChild className="vintage-button bg-transparent">
              ...
              <div key={transaction.id} className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div
                    ...
                    style={{
                      backgroundColor: transaction.amount > 0 ? "rgba(74, 103, 65, 0.2)" : "rgba(139, 74, 71, 0.2)",
                    }}
                  >
                ...
                <div className="flex items-center space-x-2">
                  <Badge
                    ...
                    style={{ backgroundColor: "rgba(214, 218, 200, 0.3)", borderColor: "#D6DAC8" }}
                  >
                    {transaction.category}
                  </Badge>
                  <span
                    className={`font-medium ${transaction.amount > 0 ? "text-vintage-income-green" : "text-vintage-expense-red"}`}
                  >
