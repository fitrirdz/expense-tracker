...
import { DollarSign, Home, Receipt, Tag, BarChart3, Menu, LogOut, User } from "lucide-react"
    ...
    <div className="flex h-full flex-col bg-vintage-cream">
      ...
      <div className="border-t p-4">
        <div className="flex items-center gap-3 mb-3">
          <div className="bg-vintage-sage/20 rounded-full p-2">
            <User className="h-4 w-4" />
          </div>
          <div className="text-sm">
            <div className="font-medium text-vintage-dark-brown">John Doe</div>
            <div className="text-muted-foreground text-vintage-dark-brown">john@example.com</div>
          </div>
        </div>
        <Button
          variant="outline"
  ...
  return (
    <div className="flex h-screen bg-vintage-cream">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-16 items-center gap-4 border-b" style={{ borderColor: "rgba(214, 218, 200, 0.3)" }}>
          <Sheet>
