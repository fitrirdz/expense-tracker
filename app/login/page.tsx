    ...
    >
      <Card className="w-full max-w-md vintage-card">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-vintage-rose">Welcome Back</CardTitle>
          <CardDescription className="text-vintage-teal">Sign in to your vintage expense tracker</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <Link href="/register" className="text-vintage-rose hover:text-vintage-rose/80 hover:underline font-medium">
              Sign up
            </Link>
          </div>
        </CardContent>
